...
@Component({
    selector     : 'chat-panel-copy',
    templateUrl  : './chat-panel-copy.component.html',
    styleUrls    : ['./chat-panel-copy.component.scss'],
    encapsulation: ViewEncapsulation.None
})
export class ChatPanelCopyComponent implements OnInit, AfterViewInit, OnDestroy
{
    contacts: any[];
    chat: any;
    selectedContact: any;
